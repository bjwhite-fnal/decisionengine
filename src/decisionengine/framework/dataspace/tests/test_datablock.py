...
def dblock(dspace, data):
    return datablock.DataBlock(dspace, data["channel_manager"][0]["name"], data["channel_manager"][0]["component_manager_id"])
...
class TestDatablock(unittest.TestCase):
    ...
    def test_DataBlock_constructor(self):
        dblock = datablock.DataBlock(self.dataspace, self.data["channel_manager"][0]["name"],
                                     self.data["channel_manager"][0]["component_manager_id"])
        ...
        dblock = datablock.DataBlock(self.dataspace, self.data["channel_manager"][0]["name"],
                                     component_manager_id=self.data["channel_manager"][0]["component_manager_id"],
                                     sequence_id=1)
        self.assertEqual(str(dblock.generation_id), self.data["dataproduct"][0]["generation_id"])

    def test_DataBlock_to_str(self):
        dataproduct = self.data["dataproduct"][0]
        header = datablock.Header(dataproduct["component_manager_id"])
        self.datablock.put(dataproduct["key"], dataproduct["value"], header)

        result = str(self.datablock)
        self.assertEqual(
            result,
            "{'component_manager_id': '1', 'generation_id': 1, 'sequence_id': 2, "
    ...
    def test_DataBlock_get_metadata(self):
        dataproduct = self.data["dataproduct"][0]
        header = datablock.Header(dataproduct["component_manager_id"])
        metadata = datablock.Metadata(dataproduct["component_manager_id"], generation_id=int(dataproduct["generation_id"]))
    ...
    def test_DataBlock_get_channel_manager(self):
        ...
        tid = self.datablock.get_channel_manager(channel_manager["name"])["component_manager_id"]
        self.assertEqual(channel_manager["component_manager_id"], tid)
    ...
    def test_DataBlock_get_channel_managers(self):
        ...
        self.assertEqual(channel_manager["component_manager_id"], tms[0]["component_manager_id"])
    ...
    def test_DataBlock_duplicate(self):
        ...
        self.assertEqual(dblock.component_manager_id, self.datablock.component_manager_id)
    ...
    def test_Metadata_constructor(self):
        ...
        metadata = datablock.Metadata(dataproduct["component_manager_id"])
        self.assertEqual(metadata.data["component_manager_id"], dataproduct["component_manager_id"])
        ...
        with self.assertRaises(datablock.InvalidMetadataError):
            metadata = datablock.Metadata(dataproduct["component_manager_id"], "INVALID_STATE")
    ...
    def test_Header_constructor(self):
        ...
        header = datablock.Header(dataproduct["component_manager_id"])
        self.assertEqual(header.data["component_manager_id"], dataproduct["component_manager_id"])
